  ...
  import ProductionForm from '@/components/crud/forms/ProductionForm';
  import ProductionTable from '@/components/crud/tables/ProductionTable';
    ...
    const EditView = () => {
      ...
      return (
        <>
          ...
          {id && <ProductionForm id={id} onSuccess={handleSuccess} />}
        </>
      );
    };
            ...
            element={
              <>
                <div className="mb-6 flex justify-between items-center">
                  <h2 className="text-2xl font-bold text-secondary-900 dark:text-white">{t('models.production.title')}</h2>
                  <button
                  ...
                  >
                    {t('commons.forms.new')} {t('models.production.title')}
                  </button>
                </div>
                <ProductionTable 
                  key={refreshTrigger} 
          ...
          <Route 
            ...
            element={
              <>
                ...
                <ProductionForm onSuccess={handleSuccess} />
              </>
            } 
          />

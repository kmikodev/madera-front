  ...
  import ApiKeyForm from '@/components/crud/forms/ApiKeyForm';
  import ApiKeyTable from '@/components/crud/tables/ApiKeyTable';
    ...
    const EditView = () => {
      ...
      return (
        <>
          ...
          {id && <ApiKeyForm id={id} onSuccess={handleSuccess} />}
        </>
      );
    };
            ...
            element={
              <>
                <div className="mb-6 flex justify-between items-center">
                  <h2 className="text-2xl font-bold text-secondary-900 dark:text-white">{t('models.apiKey.title')}</h2>
                  <button
                  ...
                  >
                    {t('commons.forms.new')} {t('models.apiKey.title')}
                  </button>
                </div>
                <ApiKeyTable 
                  key={refreshTrigger} 

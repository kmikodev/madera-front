  ...
  import MaterialForm from '@/components/crud/forms/MaterialForm';
  import MaterialTable from '@/components/crud/tables/MaterialTable';
    ...
    const EditView = () => {
      ...
      return (
        <>
          ...
          {id && <MaterialForm id={id} onSuccess={handleSuccess} />}
        </>
      );
    };
            ...
            element={
              <>
                <div className="mb-6 flex justify-between items-center">
                  <h2 className="text-2xl font-bold text-secondary-900 dark:text-white">{t('models.material.title')}</h2>
                  <button
                  ...
                  >
                    {t('commons.forms.new')} {t('models.material.title')}
                  </button>
                </div>
                <MaterialTable 
                  key={refreshTrigger} 

  ...
  import PurchaseForm from '@/components/crud/forms/PurchaseForm';
  import PurchaseTable from '@/components/crud/tables/PurchaseTable';
    ...
    const EditView = () => {
      ...
      return (
        <>
          ...
          {id && <PurchaseForm id={id} onSuccess={handleSuccess} />}
        </>
      );
    };
            ...
            element={
              <>
                <div className="mb-6 flex justify-between items-center">
                  <h2 className="text-2xl font-bold text-secondary-900 dark:text-white">{t('models.purchase.title')}</h2>
                  <button
                  ...
                  >
                    {t('commons.forms.new')} {t('models.purchase.title')}
                  </button>
                </div>
                <PurchaseTable 
                  key={refreshTrigger} 

  ...
  import EmployeeForm from '@/components/crud/forms/EmployeeForm';
  import EmployeeTable from '@/components/crud/tables/EmployeeTable';
    ...
    const EditView = () => {
      ...
      return (
        <>
          ...
          {id && <EmployeeForm id={id} onSuccess={handleSuccess} />}
        </>
      );
    };
            ...
            element={
              <>
                <div className="mb-6 flex justify-between items-center">
                  <h2 className="text-2xl font-bold text-secondary-900 dark:text-white">{t('models.employee.title')}</h2>
                  <button
                  ...
                  >
                    {t('commons.forms.new')} {t('models.employee.title')}
                  </button>
                </div>
                <EmployeeTable 
                  key={refreshTrigger} 

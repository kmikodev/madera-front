  ...
  import CustomerForm from '@/components/crud/forms/CustomerForm';
  import CustomerTable from '@/components/crud/tables/CustomerTable';
    ...
    const EditView = () => {
      ...
      return (
        <>
          ...
          {id && <CustomerForm id={id} onSuccess={handleSuccess} />}
        </>
      );
    };
            ...
            element={
              <>
                <div className="mb-6 flex justify-between items-center">
                  <h2 className="text-2xl font-bold text-secondary-900 dark:text-white">{t('models.customer.title')}</h2>
                  <button
                  ...
                  >
                    {t('commons.forms.new')} {t('models.customer.title')}
                  </button>
                </div>
                <CustomerTable 
                  key={refreshTrigger} 

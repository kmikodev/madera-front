  ...
  import RoleForm from '@/components/crud/forms/RoleForm';
  import RoleTable from '@/components/crud/tables/RoleTable';
    ...
    const EditView = () => {
      ...
      return (
        <>
          ...
          {id && <RoleForm id={id} onSuccess={handleSuccess} />}
        </>
      );
    };
            ...
            element={
              <>
                <div className="mb-6 flex justify-between items-center">
                  <h2 className="text-2xl font-bold text-secondary-900 dark:text-white">{t('models.role.title')}</h2>
                  <button
                  ...
                  >
                    {t('commons.forms.new')} {t('models.role.title')}
                  </button>
                </div>
                <RoleTable 
                  key={refreshTrigger} 

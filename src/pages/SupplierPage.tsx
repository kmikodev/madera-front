  ...
  import SupplierForm from '@/components/crud/forms/SupplierForm';
  import SupplierTable from '@/components/crud/tables/SupplierTable';
    ...
    const EditView = () => {
      ...
      return (
        <>
          ...
          {id && <SupplierForm id={id} onSuccess={handleSuccess} />}
        </>
      );
    };
            ...
            element={
              <>
                <div className="mb-6 flex justify-between items-center">
                  <h2 className="text-2xl font-bold text-secondary-900 dark:text-white">{t('models.supplier.title')}</h2>
                  <button
                  ...
                  >
                    {t('commons.forms.new')} {t('models.supplier.title')}
                  </button>
                </div>
                <SupplierTable 
                  key={refreshTrigger} 

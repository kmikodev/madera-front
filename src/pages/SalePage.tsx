  ...
  import SaleForm from '@/components/crud/forms/SaleForm';
  import SaleTable from '@/components/crud/tables/SaleTable';
    ...
    const EditView = () => {
      ...
      return (
        <>
          ...
          {id && <SaleForm id={id} onSuccess={handleSuccess} />}
        </>
      );
    };
            ...
            element={
              <>
                <div className="mb-6 flex justify-between items-center">
                  <h2 className="text-2xl font-bold text-secondary-900 dark:text-white">{t('models.sale.title')}</h2>
                  <button
                  ...
                  >
                    {t('commons.forms.new')} {t('models.sale.title')}
                  </button>
                </div>
                <SaleTable 
                  key={refreshTrigger} 

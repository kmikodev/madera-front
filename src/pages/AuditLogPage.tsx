  ...
  import AuditLogForm from '@/components/crud/forms/AuditLogForm';
  import AuditLogTable from '@/components/crud/tables/AuditLogTable';
    ...
    const EditView = () => {
      ...
      return (
        <>
          ...
          {id && <AuditLogForm id={id} onSuccess={handleSuccess} />}
        </>
      );
    };
            ...
            element={
              <>
                <div className="mb-6 flex justify-between items-center">
                  <h2 className="text-2xl font-bold text-secondary-900 dark:text-white">{t('models.auditLog.title')}</h2>
                  <button
                    onClick={() => navigate('/auditLogs/new')}
                  ...
                  >
                    {t('commons.forms.new')} {t('models.auditLog.title')}
                  </button>
                </div>
                <AuditLogTable 
                  key={refreshTrigger} 
          ...
          <Route 
            ...
            element={
              <>
                ...
                <AuditLogForm onSuccess={handleSuccess} />
              </>
            } 
          />

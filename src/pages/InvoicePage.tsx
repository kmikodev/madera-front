  ...
  import InvoiceForm from '@/components/crud/forms/InvoiceForm';
  import InvoiceTable from '@/components/crud/tables/InvoiceTable';
    ...
    const EditView = () => {
      ...
      return (
        <>
          ...
          {id && <InvoiceForm id={id} onSuccess={handleSuccess} />}
        </>
      );
    };
            ...
            element={
              <>
                <div className="mb-6 flex justify-between items-center">
                  <h2 className="text-2xl font-bold text-secondary-900 dark:text-white">{t('models.invoice.title')}</h2>
                  <button
                  ...
                  >
                    {t('commons.forms.new')} {t('models.invoice.title')}
                  </button>
                </div>
                <InvoiceTable 
                  key={refreshTrigger} 

  ...
  import SaleItemForm from '@/components/crud/forms/SaleItemForm';
  import SaleItemTable from '@/components/crud/tables/SaleItemTable';
  import { useTranslation  } from 'react-i18next';

  const SaleItemPage: React.FC = () => {
    ...
    const EditView = () => {
      ...
      return (
        <>
          ...
          {id && <SaleItemForm id={id} onSuccess={handleSuccess} />}
        </>
      );
    };
            ...
            element={
              <>
                <div className="mb-6 flex justify-between items-center">
                  <h2 className="text-2xl font-bold text-secondary-900 dark:text-white">{t('models.saleItem.title')}</h2>
                  <button
                  ...
                  >
                    {t('commons.forms.new')} {t('models.saleItem.title')}
                  </button>
                </div>
                <SaleItemTable 
                  key={refreshTrigger} 
          ...
          <Route 
            ...
            element={
              <>
                ...
                <SaleItemForm onSuccess={handleSuccess} />
              </>
            } 
          />

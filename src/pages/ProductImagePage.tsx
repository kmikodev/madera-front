  ...
  import ProductImageForm from '@/components/crud/forms/ProductImageForm';
  import ProductImageTable from '@/components/crud/tables/ProductImageTable';
  ...
  const ProductImagePage: React.FC = () => {
    ...
    const handleEdit = (id: number) => {
      navigate(`/productImages/edit/${id}`);
    };
  
    const handleSuccess = () => {
      setRefreshTrigger(prev => prev + 1);
      navigate('/productImages');
    };
    ...
    const EditView = () => {
      ...
      return (
        <>
          <div className="mb-4">
            <button
              onClick={() => navigate('/productImages')}
          ...
          {id && <ProductImageForm id={id} onSuccess={handleSuccess} />}
        </>
      );
    };
            ...
            element={
              <>
                <div className="mb-6 flex justify-between items-center">
                  <h2 className="text-2xl font-bold text-secondary-900 dark:text-white">{t('models.productImage.title')}</h2>
                  <button
                    onClick={() => navigate('/productImages/new')}
                  ...
                  >
                    {t('commons.forms.new')} {t('models.productImage.title')}
                  </button>
                </div>
                <ProductImageTable 
                  key={refreshTrigger} 
          ...
          <Route 
            ...
            element={
              <>
                ...
                <ProductImageForm onSuccess={handleSuccess} />
              </>
            } 
          />

  ...
  import WarehouseForm from '@/components/crud/forms/WarehouseForm';
  import WarehouseTable from '@/components/crud/tables/WarehouseTable';
    ...
    const EditView = () => {
      ...
      return (
        <>
          ...
          {id && <WarehouseForm id={id} onSuccess={handleSuccess} />}
        </>
      );
    };
            ...
            element={
              <>
                <div className="mb-6 flex justify-between items-center">
                  <h2 className="text-2xl font-bold text-secondary-900 dark:text-white">{t('models.warehouse.title')}</h2>
                  <button
                  ...
                  >
                    {t('commons.forms.new')} {t('models.warehouse.title')}
                  </button>
                </div>
                <WarehouseTable 
                  key={refreshTrigger} 

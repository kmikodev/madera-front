  ...
  import PurchaseItemForm from '@/components/crud/forms/PurchaseItemForm';
  import PurchaseItemTable from '@/components/crud/tables/PurchaseItemTable';
  import { useTranslation  } from 'react-i18next';

  const PurchaseItemPage: React.FC = () => {
    ...
    const EditView = () => {
      ...
      return (
        <>
          <div className="mb-4">
            <button
              onClick={() => navigate('/purchaseItems')}
          ...
          {id && <PurchaseItemForm id={id} onSuccess={handleSuccess} />}
        </>
      );
    };
            ...
            element={
              <>
                <div className="mb-6 flex justify-between items-center">
                  <h2 className="text-2xl font-bold text-secondary-900 dark:text-white">{t('models.purchaseItem.title')}</h2>
                  <button
                    onClick={() => navigate('/purchaseItems/new')}
                  ...
                  >
                    {t('commons.forms.new')} {t('models.purchaseItem.title')}
                  </button>
                </div>
                <PurchaseItemTable 
                  key={refreshTrigger} 
          ...
          <Route 
            ...
            element={
              <>
                ...
                <PurchaseItemForm onSuccess={handleSuccess} />
              </>
            } 
          />

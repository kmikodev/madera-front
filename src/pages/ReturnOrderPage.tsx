  ...
  import ReturnOrderForm from '@/components/crud/forms/ReturnOrderForm';
  import ReturnOrderTable from '@/components/crud/tables/ReturnOrderTable';
    ...
    const EditView = () => {
      ...
      return (
        <>
          ...
          {id && <ReturnOrderForm id={id} onSuccess={handleSuccess} />}
        </>
      );
    };
            ...
            element={
              <>
                <div className="mb-6 flex justify-between items-center">
                  <h2 className="text-2xl font-bold text-secondary-900 dark:text-white">{t('models.returnOrder.title')}</h2>
                  <button
                    onClick={() => navigate('/returnOrders/new')}
                  ...
                  >
                    {t('commons.forms.new')} {t('models.returnOrder.title')}
                  </button>
                </div>
                <ReturnOrderTable 
                  key={refreshTrigger} 
          ...
          <Route 
            ...
            element={
              <>
                ...
                <ReturnOrderForm onSuccess={handleSuccess} />
              </>
            } 
          />

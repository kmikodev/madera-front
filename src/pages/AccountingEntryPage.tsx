  ...
  import AccountingEntryForm from '@/components/crud/forms/AccountingEntryForm';
  import AccountingEntryTable from '@/components/crud/tables/AccountingEntryTable';
  ...
  const AccountingEntryPage: React.FC = () => {
    ...
    const handleEdit = (id: number) => {
      navigate(`/accountingEntrys/edit/${id}`);
    };
  
    const handleSuccess = () => {
      setRefreshTrigger(prev => prev + 1);
      navigate('/accountingEntrys');
    };
    ...
    const EditView = () => {
      ...
      return (
        <>
          <div className="mb-4">
            <button
              onClick={() => navigate('/accountingEntrys')}
          ...
          {id && <AccountingEntryForm id={id} onSuccess={handleSuccess} />}
        </>
      );
    };
            ...
            element={
              <>
                <div className="mb-6 flex justify-between items-center">
                  <h2 className="text-2xl font-bold text-secondary-900 dark:text-white">{t('models.accountingEntry.title')}</h2>
                  <button
                    onClick={() => navigate('/accountingEntrys/new')}
                  ...
                  >
                    {t('commons.forms.new')} {t('models.accountingEntry.title')}
                  </button>
                </div>
          ...
          <Route 
            ...
            element={
              <>
                ...
                <AccountingEntryForm onSuccess={handleSuccess} />
              </>
            } 
          />

  ...
  import UserForm from '@/components/crud/forms/UserForm';
  import UserTable from '@/components/crud/tables/UserTable';
    ...
    const EditView = () => {
      ...
      return (
        <>
          ...
          {id && <UserForm id={id} onSuccess={handleSuccess} />}
        </>
      );
    };
            ...
            element={
              <>
                <div className="mb-6 flex justify-between items-center">
                  <h2 className="text-2xl font-bold text-secondary-900 dark:text-white">{t('models.user.title')}</h2>
                  <button
                  ...
                  >
                    {t('commons.forms.new')} {t('models.user.title')}
                  </button>
                </div>
                <UserTable 
                  key={refreshTrigger} 

import React, { useState, useEffect } from 'react';
  import { Material, MaterialInput, MaterialService } from '@/services/material.service';
  ...
  const MaterialForm: React.FC<MaterialFormProps> = ({ id, onSuccess, onError }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
      ...
      try {
        ...
        if (id) {
          ...
          await MaterialService.update(id, dataToSubmit);
        } else {
          // Crear nuevo registro
          await MaterialService.create(dataToSubmit);
        }
    ...
    return (
      <div className="max-w-lg mx-auto p-4">
        <h2 className="text-xl font-bold mb-4 text-secondary-900 dark:text-white">
          {id ? t('commons.forms.edit') : t('commons.forms.create')} {t('models.material.title')}
  ...
  id="code"
  name="code"
  label={t('models.material.fields.code')}
...
/>
  ...
  id="name"
  name="name"
  label={t('models.material.fields.name')}
...
/>
  ...
  id="description"
  name="description"
  label={t('models.material.fields.description')}
...
/>
  ...
  id="unitOfMeasure"
  name="unitOfMeasure"
  label={t('models.material.fields.unitOfMeasure')}
...
/>
  ...
  id="stockQuantity"
  name="stockQuantity"
  label={t('models.material.fields.stockQuantity')}
...
/>
  ...
  id="minStockLevel"
  name="minStockLevel"
  label={t('models.material.fields.minStockLevel')}
...
/>
  ...
  id="costPrice"
  name="costPrice"
  label={t('models.material.fields.costPrice')}
...
/>
  ...
  id="deletedAt"
  name="deletedAt"
  label={t('models.material.fields.deletedAt')}
...
/>
    ...
    <label htmlFor="categoryId" className="block text-sm font-medium text-secondary-700 dark:text-secondary-300">
      {t('models.material.fields.category')}    

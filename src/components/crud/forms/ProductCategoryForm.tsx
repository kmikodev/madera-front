import React, { useState, useEffect } from 'react';
  import { ProductCategory, ProductCategoryInput, ProductCategoryService } from '@/services/productCategory.service';
  ...
  const ProductCategoryForm: React.FC<ProductCategoryFormProps> = ({ id, onSuccess, onError }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
      ...
      try {
        ...
        if (id) {
          ...
          await ProductCategoryService.update(id, dataToSubmit);
        } else {
          // Crear nuevo registro
          await ProductCategoryService.create(dataToSubmit);
        }
    ...
    return (
      <div className="max-w-lg mx-auto p-4">
        <h2 className="text-xl font-bold mb-4 text-secondary-900 dark:text-white">
          {id ? t('commons.forms.edit') : t('commons.forms.create')} {t('models.productCategory.title')}
  ...
  id="name"
  name="name"
  label={t('models.productCategory.fields.name')}
...
/>
  ...
  id="description"
  name="description"
  label={t('models.productCategory.fields.description')}
...
/>
    ...
    <label htmlFor="parentId" className="block text-sm font-medium text-secondary-700 dark:text-secondary-300">
      {t('models.productCategory.fields.parent')}    

import React, { useState, useEffect } from 'react';
  import { MaterialCategory, MaterialCategoryInput, MaterialCategoryService } from '@/services/materialCategory.service';
  ...
  const MaterialCategoryForm: React.FC<MaterialCategoryFormProps> = ({ id, onSuccess, onError }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
      ...
      try {
        ...
        if (id) {
          ...
          await MaterialCategoryService.update(id, dataToSubmit);
        } else {
          // Crear nuevo registro
          await MaterialCategoryService.create(dataToSubmit);
        }
    ...
    return (
      <div className="max-w-lg mx-auto p-4">
        <h2 className="text-xl font-bold mb-4 text-secondary-900 dark:text-white">
          {id ? t('commons.forms.edit') : t('commons.forms.create')} {t('models.materialCategory.title')}
  ...
  id="name"
  name="name"
  label={t('models.materialCategory.fields.name')}
...
/>
  ...
  id="description"
  name="description"
  label={t('models.materialCategory.fields.description')}
...
/>
    ...
    <label htmlFor="parentId" className="block text-sm font-medium text-secondary-700 dark:text-secondary-300">
      {t('models.materialCategory.fields.parent')}    
